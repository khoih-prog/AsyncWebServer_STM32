/****************************************************************************************************************************
  MQTT_ThingStream_LAN8720.ino - Dead simple AsyncWebServer for STM32 LAN8720 or built-in LAN8742A Ethernet
...
const char*  ID         = "MQTT_ThingStream_LAN8720";  // Name of our device, must be unique
...
String data         = "Hello from MQTT_ThingStream_LAN8720 on " + String(BOARD_NAME) + " with " + String(SHIELD_TYPE);
...
void setup()
{
  ...
  Serial.print("\nStart MQTT_ThingStream_LAN8720 on "); Serial.print(BOARD_NAME);
