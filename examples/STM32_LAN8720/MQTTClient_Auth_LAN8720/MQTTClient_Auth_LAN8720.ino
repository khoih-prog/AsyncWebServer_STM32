/****************************************************************************************************************************
  MQTTClient_Auth.ino - Dead simple AsyncWebServer for STM32 LAN8720 or built-in LAN8742A Ethernet
...
void reconnect()
{
  ...
  while (!client.connected())
  {
    ...
    if (client.connect("arduino", "try", "try"))
    {
      ...
      String data = "Hello from MQTTClient_Auth_LAN8720 on " + String(BOARD_NAME);
...
void setup()
{
  ...
  Serial.print("\nStart MQTTClient_Auth_LAN8720 on "); Serial.print(BOARD_NAME);
...
String data         = "Hello from MQTTClient_Auth_LAN8720 on " + String(BOARD_NAME) + " with " + String(SHIELD_TYPE);
