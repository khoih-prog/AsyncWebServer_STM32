/****************************************************************************************************************************
  MQTTClient_Basic_LAN8720.ino - Dead simple AsyncWebServer for STM32 LAN8720 or built-in LAN8742A Ethernet
...
String data         = "Hello from MQTTClient_Basic_LAN8720 on " + String(BOARD_NAME) + " with " + String(SHIELD_TYPE);
